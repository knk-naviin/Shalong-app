...
import 'Dashboard/CustomerDashboard/CustomerDashboardScreen.dart';
import 'UserAuthentication/AuthManager.dart';
import 'UserAuthentication/UserAuthScreen.dart';
import 'firebase_options.dart'; // Make sure this file is created


void main() async{
  WidgetsFlutterBinding.ensureInitialized(); // Ensures all binding is initialized
  await Firebase.initializeApp(options: DefaultFirebaseOptions.currentPlatform); // Add this line
